          ...
          <div id="results">
           ...
           refund within 5 business days back to the original account that was charged. Please confirm that everything looks good and I will complete your withdrawal.`}
            ...
            <div id="option2">
              <h4>OPTION 2</h4>
              <p>
                I have provided your refund details below. Please confirm that everything looks good and I will complete
                your withdrawal.
              </p>
              <p>
                ...
                <div id="anchor">
                  ${`${this.state.due * this.state.timeConsumed} + $${this.state.adminFee} `}
                  <a href="http://www.bloc.io/faq">non-refundable fee</a> = ${`${this.state.due *
                    this.state.timeConsumed +
